...
| :------------------ | :--------- | :------------- | :----------- | :---------------- | :-------------------- | :------------------ | :----------------------------------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Allowed               | none                | [header.schema.json](../../https:/hai.ai/schemas/=./schemas/header.schema.json "open original schema") |
...
* defined in: [Header](header-properties-jacsid.md "schemas/header/v1/header.schema.json#/properties/jacsId")
...
* defined in: [Header](header-properties-jacsversion.md "schemas/header/v1/header.schema.json#/properties/jacsVersion")
...
* defined in: [Header](header-properties-jacsversiondate.md "schemas/header/v1/header.schema.json#/properties/jacsVersionDate")
...
* defined in: [Header](header-properties-jacsagreementhash.md "schemas/header/v1/header.schema.json#/properties/jacsAgreementHash")
...
* defined in: [Header](header-properties-jacspreviousversion.md "schemas/header/v1/header.schema.json#/properties/jacsPreviousVersion")
...
* defined in: [Header](header-properties-jacsoriginalversion.md "schemas/header/v1/header.schema.json#/properties/jacsOriginalVersion")
...
* defined in: [Header](header-properties-jacsoriginaldate.md "schemas/header/v1/header.schema.json#/properties/jacsOriginalDate")
...
* defined in: [Header](header-properties-jacssha256.md "schemas/header/v1/header.schema.json#/properties/jacsSha256")
...
* defined in: [Header](header-properties-jacsfiles.md "schemas/header/v1/header.schema.json#/properties/jacsFiles")
