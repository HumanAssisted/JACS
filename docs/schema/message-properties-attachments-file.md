...
```txt
https://hai.ai/schemas/components/files/v1/files.schema.json#/properties/attachments/items
```
...
| :------------------ | :--------- | :------------- | :----------- | :---------------- | :-------------------- | :------------------ | :--------------------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Forbidden             | none                | [message.schema.json\*](../../out/message/v1/message.schema.json "open original schema") |
