...
from jacs_mcp.fast_mcp_auth import AuthClient, default_sign_request, default_validate_response
...
async def main():
    ...
    async with AuthClient(
        ...
        try:
            ...
            print(f"CLIENT: Tool Result: {result}") # Should be the echo string directly
