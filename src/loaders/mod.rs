...
pub trait FileLoader {
    ...
    // fn load_agent_public_key(&self, agentid: &String) -> String;
    // fn load_local_public_key(&self, agentid: &String) -> String;
    // fn load_local_unencrypted_private_key(&self, agentid: &String ) -> String;
