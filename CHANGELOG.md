...
- MCP server exposes 5 new tools; total 48 (was 43).
- PRD title: "Anti-Backdating" → "Anti-Backdating Research" (the deliverable is a research doc in v0.11.0; no runtime proof).
