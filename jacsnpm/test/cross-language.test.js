 ...
 *
 * IMPORTANT: verifyStandalone requires:
 *   - keyResolution: 'local'
 *   - dataDirectory: relative path from CWD to fixtures dir (contains public_keys/ subdir)
 *   - Paths must be relative (absolute paths are stripped by clean_path in storage layer)
 *
...
function fixturesRelPath() {
  return path.relative(process.cwd(), FIXTURES_DIR);
}
