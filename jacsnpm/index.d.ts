...
export interface VerifyTextOptsNapi {
  /**
...
export interface SignImageOptsNapi {
...
export interface VerifyImageOptsNapi {
...
export interface ExtractMediaOptsNapi {
  /**
...
export declare class JacsSimpleAgent {
   ...
   */
  signTextFile(filePath: string, noBackup?: boolean | undefined | null): Promise<SignTextOutcome>
  /** Short alias for [`signTextFile`]. Both wrap `sign_text_file_json`. */
  signText(filePath: string, noBackup?: boolean | undefined | null): Promise<SignTextOutcome>
  /** Sync variant of [`signTextFile`]. Returns parsed JSON via `serde_json::Value`. */
  signTextFileSync(filePath: string, noBackup?: boolean | undefined | null): unknown
  /** Sync variant of the [`signText`] alias. */
  signTextSync(filePath: string, noBackup?: boolean | undefined | null): unknown
  /**
   ...
   */
  verifyTextFile(filePath: string, opts?: VerifyTextOptsNapi | undefined | null): Promise<VerifyTextResult>
  /** Short alias for [`verifyTextFile`]. */
  verifyText(filePath: string, opts?: VerifyTextOptsNapi | undefined | null): Promise<VerifyTextResult>
  /** Sync variant of [`verifyTextFile`]. */
  verifyTextFileSync(filePath: string, opts?: VerifyTextOptsNapi | undefined | null): unknown
  /** Sync variant of the [`verifyText`] alias. */
  verifyTextSync(filePath: string, opts?: VerifyTextOptsNapi | undefined | null): unknown
  /**
   ...
   */
  signImage(inputPath: string, outputPath: string, opts?: SignImageOptsNapi | undefined | null): Promise<SignImageOutcome>
  /** Sync variant of [`signImage`]. */
  signImageSync(inputPath: string, outputPath: string, opts?: SignImageOptsNapi | undefined | null): unknown
  /**
   ...
   */
  verifyImage(filePath: string, opts?: VerifyImageOptsNapi | undefined | null): Promise<VerifyImageResult>
  /** Sync variant of [`verifyImage`]. */
  verifyImageSync(filePath: string, opts?: VerifyImageOptsNapi | undefined | null): unknown
  /**
