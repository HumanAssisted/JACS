...
"
    ...
    let agent = jacs::agent::Agent::new("v1", "v1", "v1").expect("agent should construct");
    let agent_one_public_key = public_key_with_newline.clone();
