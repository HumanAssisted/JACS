...
### verify_text(path, *, strict=False, key_dir=None) — v0.11.0
...
### sign_image(path, *, out=None, robust=False, refuse_overwrite=False) — v0.11.0
...
### verify_image(path, *, strict=False, key_dir=None) — v0.11.0
...
### extract_media_signature(path, *, raw_payload=False) — v0.11.0
